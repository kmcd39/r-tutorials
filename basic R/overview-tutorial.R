...
# cylinders, and the count of rows in the dataset with each number of cyclinders.

# use ggplot -- tidyverse visualization technique to make a more complex plot things
